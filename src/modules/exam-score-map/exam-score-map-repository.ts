...
import { ExamScoreMap } from '../../models'
...
const MODEL = ExamScoreMap
const MODEL_NAME = 'ExamScoreMap'
...
export const findByExamId = async (exam_id: string) => (
  R.pipeWith(R.andThen)([
    async () => MODEL.where({ exam_id }).orderBy('score').fetchAll(),
    collectionToJson,
  ])(true)
)
