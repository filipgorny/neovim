...
const MODEL = StudentBookContentCourseTopic
const MODEL_NAME = 'StudentBookContentCourseTopic'
...
export const patchCustom = async (qb, data: object) => (
...
export const deleteByContentId = async (content_id: string) => (
  _delete(MODEL)({ student_book_content_id: content_id })
)
