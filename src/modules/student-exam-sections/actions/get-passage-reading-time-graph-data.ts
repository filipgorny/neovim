...
import { buildPassageTimeGraphData } from '../../../../services/student-exam-sections/graph/passage-reading-time-you'
...
export default timerType => async (student, sectionId) => {
  ...
  return R.pipe(
    ...
    buildPassageTimeGraphData(timerType)
  )(section)
}
