...
import { findArchivedStudentFlashcards } from '../student-book-content-flashcard-repository'
...
export default async (studentId: string, query, studentCourse) => (
  R.pipeWith(R.andThen)([
    async () => findArchivedStudentFlashcards(studentId, studentCourse, query.part)(prepareQuery(query), query.filter),
    R.over(
      R.lensProp('data'),
