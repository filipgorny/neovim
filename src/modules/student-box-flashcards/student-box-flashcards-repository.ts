import { StudentBoxFlashcard } from '../../models'
...
const MODEL = StudentBoxFlashcard
const MODEL_NAME = 'StudentBoxFlashcard'
...
export const deleteByFlashcardId = async (student_flashcard_id: string) => (
