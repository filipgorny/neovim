import { CalendarSetting } from '../../models'
...
const MODEL = CalendarSetting
const MODEL_NAME = 'CalendarSetting'

export const create = async (dto: {}, trx?) => (
  _create(MODEL)(dto, trx)
)

export const findOne = async (where: {}): Promise<CalendarSettings> => (
