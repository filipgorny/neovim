import { StudentBookContentsRead } from '../../models'
...
const MODEL = StudentBookContentsRead
const MODEL_NAME = 'StudentBookContentsRead'
...
export const fetchReadContent = async (studentCourse, fromDate) => (
  findCustom(
    StudentBookContentsRead
      .where('updated_at', '>', fromDate)
      .andWhere('student_course_id', studentCourse.id)
  )({ take: 100, page: 1 }, { by: 'updated_at', dir: 'desc' })
)
