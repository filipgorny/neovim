...
- ALWAYS preserve the existing formatting of the file being edited (indentation, quotes, semicolons, line breaks). Match the conventions already present in the file, not your own defaults.
